page 50159 "Copy Material Req. Page_IXO"
{
    PageType = StandardDialog;
    Caption = 'Copy Exisiting Material Requisition';
    // ApplicationArea = All;
    ...
    layout
    {
        area(Content)
        {
            group("Select Document to Copy")
            {
                ...
                {
                    ApplicationArea = All;
                    LookupPageId = "Material Requisition_IXO";
                    TableRelation = "Purchase Req. Header_IXO"."Document No." where("Document Type" = const(Material));
                }
            }
        }
    }
    ...
    begin
        TestCode := RecCode;
        recPurchReqLines.SetFilter("Document Type", 'Material');
        ...
        IF recPurchReqLines.FindSet() then
            repeat
                ...
                copyRecPurchReqLines."Document Type" := recPurchReqLines."Document Type";
